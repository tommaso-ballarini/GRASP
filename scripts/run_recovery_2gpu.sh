...
#SBATCH --mem=128GB
#SBATCH --job-name=R2P_Recovery
#SBATCH --output=logs/pipeline_30/recovery_%j.out
#SBATCH --error=logs/pipeline_30/recovery_%j.err
...
CUDA_VISIBLE_DEVICES=1 python flux_server.py --port $FLUX_PORT > logs/pipeline_30/flux_server_${SLURM_JOB_ID}.log 2>&1 &
FLUX_PID=$!
...
# ==========================================
# 2. AVVIO RECOVERY LOOP (Su GPU 0 con Qwen3)
# ==========================================
echo "⚖️ Avvio Pipeline Recovery (GPU 0)..."
